        ...
        <div className="container p-4">
            <div className="row align-items-center flex-column flex-md-row">
                ...
                <div className="col-md-7">
                    <h2 className="fw-bold display-6 text-center text-md-start">
                        End-to-end Blockchain Development Services
                    </h2>
                    <p
                        className="text-muted col-lg-10 mx-auto mx-md-0"
                        style={{
...
{/* list Content */}
                    <ul className="list-unstyled mt-4 fs-5">
                        <li className="d-flex align-items-start mb-3">
                            ...
                            <span className="text-wrap flex-grow-1 mt-1" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 200, fontSize: "16px" }}>
